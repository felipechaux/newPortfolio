export const translations = {
    en: {
        nav: { how: "How It Works", features: "Features", screenshots: "Screenshots", download: "Download" },
        hero: {
            badge: "Social Icebreaker App",
            title1: "Less scroll,",
            title2: "more action.",
        ...
        features: {
            ...
            list: [
                ...
                { icon: "✨", title: "Free & Pro", desc: "Start free with daily rolls. Go Pro for unlimited launches and exclusive environments." }
            ]
        },
        screenshots: {
            eyebrow: "See it in action",
            title: "App Screenshots",
            headline: "Beautiful neon design, built for connection.",
            body: "DadoMatch combines a stunning dark neon aesthetic with powerful AI technology. Every screen is crafted to feel premium and intuitive — because breaking the ice should feel as good as the conversation that follows.",
            list: [
    ...
    es: {
        ...
        hero: {
            badge: "App de rompehielos social",
            title1: "Menos scroll,",
            title2: "más acción.",
        ...
        features: {
            ...
            list: [
                ...
                { icon: "✨", title: "Gratis & Pro", desc: "Empieza gratis con tiradas diarias. Hazte Pro para tiradas ilimitadas." }
            ]
        },
        screenshots: {
            eyebrow: "Mírala en acción",
            title: "Capturas de pantalla",
            headline: "Diseño neón premium, hecho para conectar.",
            body: "DadoMatch combina una estética neón oscura con potente tecnología de IA. Cada pantalla está diseñada para ser intuitiva y de alta calidad.",
            list: [
                "✦ Kotlin Multiplatform (iOS + Android)",
                "✦ UI en Compose Multiplatform",
                "✦ IA Generativa via Gemini",
                "✦ Autenticación con Firebase",
                "✦ Suscripciones con RevenueCat"
            ],
            captions: [
                'Bienvenido a DadoMatch',
                'Elige entorno e intensidad',
                'Frase instantánea con IA',
                'Feedback para mejorar tu Rizz',
                'Mide tu progreso social'
            ]
        },
        tech: {
